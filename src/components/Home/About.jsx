...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Had an emergency tyre issue. Really helpful on the phone, allowed us to bring the tyre to them to see what the issue was. Replaced the valve there and then. Really helpful service.",
    name: "Charlotte Byrnes",
  },
